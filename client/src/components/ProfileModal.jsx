...
const EditNoteModal = ({ note, onClose, onSave }) => {
  ...
  const skeletonStyle = 'bg-gray-200 animate-pulse rounded-md';
            ...
            <form className="p-4 md:p-5" onSubmit={handleSave}>
              <div className="grid gap-4 mb-4 grid-cols-1">
                <div>
                  ...
                  {loading ? (
                    <div className={`${skeletonStyle} h-10 w-full`}></div>
                  ) : (
                    <input
                      type="text"
                      id="title"
                ...
                <div>
                  ...
                  {loading ? (
                    <div className={`${skeletonStyle} h-24 w-full`}></div>
                  ) : (
                    <textarea
                      id="content"
                      rows="4"
              ...
              <div className='w-full flex justify-center items-center mt-10'>
                ...
                >
                  {loading ? (
                    <div className={`${skeletonStyle} w-full h-10`}></div>
                  ) : (
                    <>
